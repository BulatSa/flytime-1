...
<head>
	...
	<title>Время летать</title>

	<!-- og -->
	<meta property="og:title" content="Время летать">
	<meta property="og:description" content="Время летать">
...
<div class="mob-panel">
	<div class="container">
		...
		<nav class="top-nav">
			...
			<a href="/delivery.php" class="active">Доставка</a>
